...
const BlogNavBar = () => {
  return (
    <nav className="m-5 w-[90vw] p-[1rem] items-center rounded-lg flex justify-between mx-auto bg-[#FEFEFEB2] blog-nav-bar min-[1000px]:grid min-[1000px]:grid-cols-3 min-[1000px]:gap-2">
